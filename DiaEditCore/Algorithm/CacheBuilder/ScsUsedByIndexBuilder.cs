...
/// （値がListである理由：v12.19設計セッションで確定した通り、SCは「複々線・双単線区間における
/// 経路をユーザーが分かりやすいようにグルーピングするための用途」であり、同一(MainRouteId, Direction)
/// 内で同一SCSが複数のStationConnectionから参照されることは許容しない（複線区間は物理的に1本の
